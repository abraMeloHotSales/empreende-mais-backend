...
/*
|--------------------------------------------------------------------------
| API Routes - Empreende+
|--------------------------------------------------------------------------
|
| Todas as rotas estão abertas (sem autenticação) enquanto o banco de dados
| não está configurado. Os retornos são dados estáticos.
| Quando o banco estiver pronto, reativar o middleware 'auth:sanctum'.
|
*/
